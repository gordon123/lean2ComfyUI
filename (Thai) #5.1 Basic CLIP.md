...
หาก CLIP ได้รับภาพคู่กับข้อความ "ฉันรักเธอ", ระบบจะทำงานดังนี้: <br>
...
### **🔹 Cosine Similarity with "A cat"** <br>
...
ถ้าอธิบายภาษาบ้าน ๆ คือ เหมือนเป็นตัวกรอง และข้อเป้าข้อมูล ใหญ่ ๆ ให้เจอสิ่งที่ต้องการ  <br>
